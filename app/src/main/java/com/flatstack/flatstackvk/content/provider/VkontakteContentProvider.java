...
public class VkontakteContentProvider extends ContentProvider {
    ...
    static {
        addUri(URI_MATCHER, NewsFeedDao.TABLE, true);
        addUri(URI_MATCHER, UserDAO.TABLE, true);
        addUri(URI_MATCHER, ProfilesDAO.TABLE, true);
        addUri(URI_MATCHER, GroupsDAO.TABLE, true);
    }
